...
export interface LocalReviewRepairContext {
  repairIntent?: "same_pr_follow_up" | "same_pr_manual_review_residual" | "high_severity_retry" | "unspecified";
  summaryPath: string;
          ...
          ...(input.localReviewRepairContext
            ? [
                input.localReviewRepairContext.repairIntent === "same_pr_follow_up"
                  ...
                  : input.localReviewRepairContext.repairIntent === "same_pr_manual_review_residual"
                    ? "- Repair intent: same-PR repair for current-head local-review residuals that would otherwise require manual review. Keep operator-facing summaries aligned with the saved manual_review_blocked result until a fresh local review says otherwise."
