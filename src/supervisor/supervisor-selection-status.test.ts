...
import {
  ...
  buildIssueLintDto as buildIssueLintDtoFacade,
  ...
  renderIssueLintDto as renderIssueLintDtoFacade,
...
test("supervisor-selection-status facade re-exports the dedicated status modules", () => {
  ...
  assert.equal(buildIssueLintDtoFacade, buildIssueLintDto);
  assert.equal(renderIssueLintDtoFacade, renderIssueLintDto);
