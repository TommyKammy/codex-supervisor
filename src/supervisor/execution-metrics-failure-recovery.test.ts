...
test("buildExecutionMetricsRunSummaryArtifact extends finishedAt to cover later failure and recovery observations", () => {
  assert.deepEqual(
    buildExecutionMetricsRunSummaryArtifact({
      issueNumber: 896,
      terminalState: "blocked",
      issueCreatedAt: "2026-03-24T00:00:00Z",
      startedAt: "2026-03-24T00:01:00Z",
      finishedAt: "2026-03-24T00:03:00Z",
      blockedReason: "verification",
      failureKind: "command_error",
      failureContext: {
        category: "review",
        ...
        command: "npm test",
        details: ["suite=supervisor"],
        url: "https://example.test/issues/896",
        updated_at: "2026-03-24T00:04:00Z",
      },
      recoveryEvents: [
        {
          issueNumber: 896,
          reason: "operator_requeue: requeued issue #896 from blocked to queued",
          at: "2026-03-24T00:06:00Z",
        },
      ],
      lastRecoveryReason: "operator_requeue: requeued issue #896 from blocked to queued",
      lastRecoveryAt: "2026-03-24T00:06:00Z",
    }),
    {
      schemaVersion: 4,
